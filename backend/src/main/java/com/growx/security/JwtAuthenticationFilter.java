 ...
 * If valid, sets the authenticated user in the SecurityContext so that
 * subsequent controller layers can call SecurityContextHolder.getContext().getAuthentication().
 *
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Invalid or expired JWT — let the request proceed without authentication.
